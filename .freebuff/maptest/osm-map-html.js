...
exports.CENTER_LNG = exports.CENTER_LAT = void 0;
exports.resolveTileProvider = resolveTileProvider;
exports.buildMapHtml = buildMapHtml;
exports.CENTER_LAT = 14.582;
exports.CENTER_LNG = 121.132;
...
function json(value) {
    return JSON.stringify(value !== null && value !== void 0 ? value : null).replace(/</g, '\\u003c');
}
/**
...
<script>
  ...
  var __focus = ${json((_a = state.focus) !== null && _a !== void 0 ? _a : null)};
  var __maxArea = ${json(area)};
  var __activePinId = ${json((_b = state.activePinId) !== null && _b !== void 0 ? _b : null)};
  var __user = ${json((_c = state.userLocation) !== null && _c !== void 0 ? _c : null)};

  var map = L.map('map', { zoomControl: false, scrollWheelZoom: true, attributionControl: true, maxBoundsViscosity: 0.8 })
    .setView([${exports.CENTER_LAT}, ${exports.CENTER_LNG}], 14);
  ...
  function fitAll() {
    ...
    else { map.setView([${exports.CENTER_LAT}, ${exports.CENTER_LNG}], 14); }
  }
